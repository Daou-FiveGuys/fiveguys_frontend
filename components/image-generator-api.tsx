...
import {imgResponse} from "@/components/chat/send-message/create-message";
...
export async function postImageGenerate(imageOption: ImageOption, prompt: string): Promise<imgResponse> {
  let iR: imgResponse = {
    requestId: '',
    url: ''
  };
